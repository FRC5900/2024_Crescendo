...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Pick Up Ring", new ParallelCommandGroup(
        new AutoIntakeCmd(m_IntakeSubsystem, m_ShooterSubsystem, m_PivotSubsystem),
  ...
  private void configureButtonBindings() {
    new JoystickButton(m_driverController, 6) //Right Bumper, X-State
    ...
    new JoystickButton(m_driverController, 4) //Y, Turbo
    ...
    new JoystickButton(m_operatorController, 5) //Left Bumper, Intake
        .whileTrue(new IntakeSetCmd(m_IntakeSubsystem,m_ShooterSubsystem, 0.4));

    new JoystickButton(m_operatorController, 7) //Left Bumper, Intake
        .whileTrue(new IntakeSetCmd(m_IntakeSubsystem,m_ShooterSubsystem, -0.25));
    ...
    new JoystickButton(m_operatorController, 3) //X, Shoot Amp
        .whileTrue(new ShooterSetCmd(m_ShooterSubsystem, m_IntakeSubsystem, .25, -1000));

    new JoystickButton(m_operatorController, 1) // A, Pivot to Ground
        .whileTrue(new RunCommand(
        () -> m_PivotSubsystem.ToGround()));
