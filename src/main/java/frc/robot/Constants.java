...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorCurrentLimit = 25; // amps  Original 50
    public static final int kTurningMotorCurrentLimit = 10; // amps  Original 20
  }
  ...
  public static final class ShooterConstants {
    public static final int kShooterMotorCanId1 = 14;
    public static final int kShooterMotorCanId2 = 12;
  }

  public static final class IntakeConstants {
    public static final int kIntakeMotorCanId1 = 20;
    public static final int kIntakeMotorCanId2 = 10;
    public static final int kSensorPort = 1;
  }

  public static final class PivotConstants {
    public static final int kPivotMotorCanId1 = 15;
    public static final int kPivotMotorCanId2 = 16;
    public static final int kEncoderPort = 0;

    public static final int kGroundPoint = 293;
    public static final double kShootingPoint = 288;
    public static final int kStartPoint = 204;
    public static final int kAmpPoint = 185;
  }
}
